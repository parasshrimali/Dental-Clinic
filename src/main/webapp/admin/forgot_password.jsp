	...
	<div class="container">
		...
		if ("POST".equalsIgnoreCase(request.getMethod()) && "validateSecurity".equals(request.getParameter("action"))) {
			...
			try {
				...
				String sql = "SELECT recovery_question, recovery_answer FROM admin WHERE name = ? AND recovery_question = ?";
		...
		<form method="post">
			...
			<p class="text-center mt-3" data-aos="fade-up" data-aos-delay="700">
				Already Registered? <a href="admin_login.jsp" style="color: #353B4D">Login</a>
			</p>
		</form>
