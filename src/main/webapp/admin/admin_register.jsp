...
<link rel="stylesheet" type="text/css"
	href="../admin_css/adminregister.css">
</head>
<body>


	<div class="card-container">
		<div class="card shadow-lg" data-aos="zoom-in" data-aos-delay="200">
			<h2 class="text-center mb-4" data-aos="fade-down"
				data-aos-delay="300">Register Admin</h2>
			...
			<form id="registrationForm" method="post" class="needs-validation"
				...
				<button type="submit" class="btn btn-dark w-100" data-aos="zoom-in"
					data-aos-delay="1100">Register</button>
				<p class="text-center mt-3" data-aos="fade-up" data-aos-delay="1200">
					Already Registered? <a href="admin_login.jsp"
	...
	if ("POST".equalsIgnoreCase(request.getMethod())) {
		...
		sb.append(String.format("%02x", b));
			...
			String checkQuery = "SELECT * FROM admin WHERE email = ? OR phone = ? OR name = ?";
		...
		String insertQuery = "INSERT INTO admin (id, name, password, email, phone, recovery_question, recovery_answer) VALUES (?, ?, ?, ?, ?, ?, ?)";
